...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2012 at 01:50 PM
...
INSERT INTO `voter` (`ID`, `username`, `password`, `role_id`) VALUES
(1, 'Oor', '1234', 1),
(2, 'Metas', '5678', 1),
(3, 'Guysit', 'i4cu', 1),
(4, 'peepo', 'peepo', 1),
...
--
ALTER TABLE `vote`
  ADD CONSTRAINT `vote_fk1` FOREIGN KEY (`user_id`) REFERENCES `voter` (`ID`) ON UPDATE CASCADE,
...
--
ALTER TABLE `voter`
  ADD CONSTRAINT `voter_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `roles` (`ID`) ON UPDATE NO ACTION;
